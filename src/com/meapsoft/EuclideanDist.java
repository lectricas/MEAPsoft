...
/**
 * Simple distance metric calculating the euclidean distance (squared)
...
public class EuclideanDist extends ChunkDist 
{
    ...
    public EuclideanDist(ChunkDist o) { super(o); }
    public EuclideanDist(int[] i) { super(i); }
    public EuclideanDist(ChunkDist o, int[] i) { super(o,i); }
