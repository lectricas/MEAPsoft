...
{
	public static String description = "BlipComposer inserts a blip at the beginning of each chunk in the input " +
	...
	{
		System.out.println("Usage: BlipComposer [-options] features.feat \n\n" + 
