...
public class RotComposer extends Composer
{
	...
	public RotComposer(FeatFile featFN, EDLFile outFN, int beatsPerMeasure, int numPositions, boolean left)
	{
	...
	{
		System.out.println("Usage: RotComposer [-options] features.feat \n\n" + 
